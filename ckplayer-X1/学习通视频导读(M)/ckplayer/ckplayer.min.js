...
!(function() {
  ...
  var ckplayer = function(obj) {
    ...
    this.adType = "";
    this.adI = 0;
    this.videoTemp = { src: "", source: "", currentSrc: "", loop: false };
  ...
  ckplayer.prototype = {
            ...
            if (type == "mp4" || type == "mov" || this.isStrImage(type)) {
              var obj = {
                ...
                time:
                  parseInt(adtime[i]) > 0
                    ? parseInt(adtime[i])
                    : this.ckplayerConfig["style"]["advertisement"]["time"],
                link: adlink[i]
              };
              adList.push(obj);
            }
    ...
    interFace: function() {
      ...
      var bBgColor = "#FFFFFF",
        bOverColor = "#0782F5";
      var timeInto =
        this.formatTime(0) + " / " + this.formatTime(this.vars["duration"]);
        ...
        if (this.ckplayerConfig["style"]["logo"]["file"]) {
          ...
          if (
            ...
            this.getByElement(logoID).innerHTML =
              '<img src="' + logoFile + '" border="0">';
          }
        }
      } else {
        this.getByElement(logoID).innerHTML =
          this.vars["logo"] || this.logo || "";
      }
      var pd = this.PD;
      this.CB = {
      ...
      var cAdEscMute = this.getByElement(adEscMuteID + "-canvas").getContext(
        "2d"
      );
    ...
    timeButtonMouseDown: function() {
      ...
      var timeBoBgmousemove = function(event) {
        ...
        var eventTime = parseInt(
          ((eventX - timeBoBgXY["x"]) * thisTemp.V.duration) /
    ...
    loadingStart: function(rot) {
      ...
      var loadingFun = function() {
        ...
        try {
          nowRotate =
            thisTemp.css(thisTemp.CB["loadingCanvas"], "transform") ||
    ...
    keypress: function() {
      ...
      var keyDown = function(eve) {
        ...
        switch (keycode) {
          ...
          case 38:
            now =
              thisTemp.volume + thisTemp.ckplayerConfig["config"]["volumeJump"];
    ...
    elementCoordinate: function() {
      ...
      try {
        this.css(this.CB["logo"], {
          left:
            parseInt(this.PD.offsetWidth - this.CB["logo"].offsetWidth - 20) +
            "px",
          top: "20px"
        });
      } catch (event) {}
    ...
    loadAdvertisements: function() {
      ...
      if (this.isStrImage(type)) {
        this.css(
          [this.CB["adBackground"], this.CB["adElement"], this.CB["adBar"]],
          "display",
          "block"
        );
    ...
    ajaxSuccessNull: function(url) {
      if (!this.isUndefined(url)) {
        var ajaxObj = { url: url, success: function(data) {} };
        this.ajax(ajaxObj);
      }
    },
    ...
    changeConfig: function() {
      ...
      switch (arg.length) {
        ...
        case 7:
          ...
          break;
        case 8:
          this.ckplayerConfig[arg[0]][arg[1]][arg[2]][arg[3]][arg[4]][arg[5]][
            arg[6]
          ] = val;
          break;
        case 9:
    ...
    getNowDate: function() {
      ...
      return (
        tMonth + "/" + tDate + " " + tHours + ":" + tMinutes + ":" + tSeconds
      );
    },

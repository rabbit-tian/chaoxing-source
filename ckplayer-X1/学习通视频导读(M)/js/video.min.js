!(function(t, e) {
    ...
    return (
      Object.getOwnPropertyNames(e).forEach(function(t) {
        ...
        -1 !== t.indexOf("aria-") || "role" === t || "type" === t
          ? (Ye.warn(Ge($e, t, n)), i.setAttribute(t, n))
          : "textContent" === t
          ? y(i, n)
          : (i[t] = n);
      }),
  ...
  function y(t, e) {
    return (
      void 0 === t.textContent ? (t.innerText = e) : (t.textContent = e), t
    );
  }
  function g(t, e) {
  ...
  function _(t, e) {
    return (
      t.classList
        ? t.classList.add(e)
        : m(t, e) || (t.className = (t.className + " " + e).trim()),
      t
    );
  }
  function b(t, e) {
  ...
  function O(t, e) {
    ...
    return (
      e.changedTouches &&
        ((c = e.changedTouches[0].pageX), (l = e.changedTouches[0].pageY)),
  ...
  function W(t, e) {
    ...
    0 === n.handlers[e].length &&
      ...
      0 === Object.getOwnPropertyNames(n).length && H(t);
  }
  function U(t, e, n, r) {
    ...
    if (!t || !t.isPropagationStopped) {
      ...
      for (var i in r)
        "layerX" !== i &&
          ...
          "webkitMovementX" !== i &&
          "webkitMovementY" !== i &&
          (("returnValue" === i && r.preventDefault) || (t[i] = r[i]));
      if (
        (t.target || (t.target = t.srcElement || de),
        t.relatedTarget ||
          (t.relatedTarget =
      ...
      if (r.handlers) {
        ...
        if (void 0 !== e) {
          ...
          for (var a in r.handlers)
            Object.prototype.hasOwnProperty.call(r.handlers || {}, a) &&
              i(t, a);
      }
    }
  }
  ...
  function st(t) {
    ...
    "number" == typeof t
      ...
      : "string" == typeof t
      ? (this.message = t)
      : i(t) && ("number" == typeof t.code && (this.code = t.code), r(this, t)),
  ...
  function _t(t) {
          ...
          0 !== e
            ? ((r = {
              ...
              a.getAllResponseHeaders &&
                (r.headers = hr(a.getAllResponseHeaders())))
    ...
    a ||
      (a =
        t.cors || t.useXDR ? new mt.XDomainRequest() : new mt.XMLHttpRequest());
    var l,
      c,
      u,
      h = (a.url = t.uri || t.url),
    ...
    else if (t.headers && !yt(t.headers))
  ...
  function St(t, e, n) {
    function r() {
      var e = kt(t);
      if (null === e)
        throw new Ct(Ct.Errors.BadTimeStamp, "Malformed timestamp: " + o);
            ...
            switch (t) {
              ...
              case "line":
                ...
                r.integer(t, s),
                  ...
                  r.alt(t, s, ["auto"]),
                  2 === o.length &&
                    r.alt("lineAlign", o[1], ["start", "middle", "end"]);
                break;
              case "position":
                (o = e.split(",")),
                  r.percent(t, o[0]),
                  2 === o.length &&
                    r.alt("positionAlign", o[1], ["start", "middle", "end"]);
                break;
              case "size":
                r.percent(t, e);
                break;
  ...
  function It(t, e, n, r) {
    ...
    if (o.snapToLines) {
      ...
      Math.abs(u) > h && ((u = u < 0 ? -1 : 1), (u *= Math.ceil(h / c) * c)),
        s < 0 &&
          ((u += "" === o.vertical ? n.height : n.width), (a = a.reverse())),
        i.move(p, u);
    } else {
    ...
    var f = (function(t, e) {
      for (var i, o = new Mt(t), s = 1, a = 0; a < e.length; a++) {
        for (
          ;
          t.overlapsOppositeAxis(n, e[a]) || (t.within(n) && t.overlapsAny(r));
  ...
  function re(t, e, n) {
    ...
    if (r.player || po.players[r.playerId])
      return r.player || po.players[r.playerId];
    p(r) &&
      !de.body.contains(r) &&
      Ye.warn("The element supplied is not included in the DOM"),
      (e = e || {}),
      re.hooks("beforesetup").forEach(function(t) {
        var n = t(r, tt(e));
    ...
    var s = En.getComponent("Player"),
      a = new s(r, e, n);
    return (
      re.hooks("setup").forEach(function(t) {
        return t(a);
      }),
      a
    );
  ...
  var ae,
    le = ie,
    ce = {},
    ue = (Object.freeze || Object)({ default: ce }),
    he = (ue && ce) || ue,
    pe = void 0 !== se ? se : "undefined" != typeof window ? window : {};
  "undefined" != typeof document
    ? (ae = document)
    : (ae = pe["__GLOBAL_DOCUMENT_CACHE@4"]) ||
      (ae = pe["__GLOBAL_DOCUMENT_CACHE@4"] = he);
  var de = ae,
    ...
    Oe = (function() {
      var t = /MSIE\s(\d+)\.\d/.exec(fe),
        e = t && parseFloat(t[1]);
      return (
        !e && /Trident\/7.0/i.test(fe) && /rv:11.0/.test(fe) && (e = 11), e
      );
    })(),
    ...
    Ie =
      h() &&
      ("ontouchstart" in le ||
        (le.DocumentTouch && le.document instanceof le.DocumentTouch)),
    ...
    Ke = function(t, e) {
      ...
      if (
        ...
        var s = le.console[t];
        s || "debug" !== t || (s = le.console.info || le.console.log),
          s &&
            r &&
            o.test(t) &&
            (n &&
              (e = e
                ...
                .join(" ")),
            s.apply
              ? s[Array.isArray(e) ? "apply" : "call"](le.console, e)
              : s(e));
      }
    };
  (ze = function() {
  ...
  !(function() {
    try {
      ...
      le.addEventListener("test", null, t),
        le.removeEventListener("test", null, t);
    } catch (t) {}
  })();
  ...
  (fn.prototype.allowedEvents_ = {}),
    ...
    (fn.prototype.addEventListener = fn.prototype.on),
    (fn.prototype.off = function(t, e) {
      q(this, t, e);
    }),
    (fn.prototype.removeEventListener = fn.prototype.off),
    (fn.prototype.one = function(t, e) {
      var n = this.addEventListener;
      (this.addEventListener = function() {}),
        Y(this, t, e),
        (this.addEventListener = n);
      ...
      off: function(t, e, n) {
        if (!t || yn(t)) q(this.eventBusEl_, t, e);
          ...
          gn(r),
            ...
            this.off("dispose", n),
            r.nodeName
              ? (q(r, i, n), q(r, "dispose", n))
              : vn(r) && (r.off(i, n), r.off("dispose", n));
        }
      },
    ...
    kn = {
      ...
      setState: function(t) {
        ...
        return (
          e(t, function(t, e) {
            n.state[e] !== t &&
              ((r = r || {}), (r[e] = { from: n.state[e], to: t })),
              (n.state[e] = t);
          }),
          r && vn(this) && this.trigger({ changes: r, type: "statechanged" }),
          r
        );
      }
    },
    En = (function() {
      function t(e, n, r) {
        if (
          ...
          (n = this.options_ = tt(this.options_, n)),
        ...
        (this.name_ = n.name || null),
          ...
          !1 !== n.evented && $(this, { eventBusKey: this.el_ ? "el_" : null }),
      ...
      return (
        ...
        (t.prototype.options = function(t) {
          return (
            ...
            t
              ? ((this.options_ = tt(this.options_, t)), this.options_)
              : this.options_
          );
        }),
        ...
        (t.prototype.dimension = function(t, e, n) {
          ...
          return -1 !== i
            ...
            : parseInt(this.el_["offset" + Q(t)], 10);
        }),
        ...
        (t.prototype.emitTapEvents = function() {
          ...
          this.on("touchstart", function(r) {
            1 === r.touches.length &&
              ((e = { pageX: r.touches[0].pageX, pageY: r.touches[0].pageY }),
              (t = new Date().getTime()),
              (n = !0));
          }),
  ...
  (En.prototype.supportsRaf_ =
    "function" == typeof le.requestAnimationFrame &&
    "function" == typeof le.cancelAnimationFrame),
  ...
  for (var On = 0; On < st.errorTypes.length; On++)
    (st[st.errorTypes[On]] = On), (st.prototype[st.errorTypes[On]] = On);
  var Nn = at,
    Mn = function(t) {
      return [
        "kind",
    ...
    Ln = { textTracksToJson: In, jsonToTextTracks: Dn, trackToJson_: Mn },
    Rn = "vjs-modal-dialog",
    Bn = (function(t) {
      function e(n, r) {
        Be(this, e);
      ...
      return (
        ...
        (e.prototype.conditionalFocus_ = function() {
          ...
          (this.previouslyActiveEl_ = null),
            (e.contains(t) || e === t) &&
              ...
              this.focus(),
              this.on(de, "keydown", this.handleKeyDown));
        }),
        (e.prototype.conditionalBlur_ = function() {
          this.previouslyActiveEl_ &&
            (this.previouslyActiveEl_.focus(),
            (this.previouslyActiveEl_ = null)),
            this.off(de, "keydown", this.handleKeyDown);
        }),
        ...
        (e.prototype.focusableEls_ = function() {
          ...
          return Array.prototype.filter.call(t, function(t) {
            return (
              ((t instanceof le.HTMLAnchorElement ||
                t instanceof le.HTMLAreaElement) &&
                t.hasAttribute("href")) ||
              ((t instanceof le.HTMLInputElement ||
                t instanceof le.HTMLSelectElement ||
                t instanceof le.HTMLTextAreaElement ||
                t instanceof le.HTMLButtonElement) &&
                !t.hasAttribute("disabled")) ||
              t instanceof le.HTMLIFrameElement ||
              t instanceof le.HTMLObjectElement ||
              t instanceof le.HTMLEmbedElement ||
  ...
  (Bn.prototype.options_ = { pauseOnOpen: !0, temporary: !0 }),
  ...
  var Hn = function(t, e) {
    ...
    Wn = (function(t) {
      function e() {
        ...
        if (Pe) {
          ...
          for (var a in Fn.prototype)
            "constructor" !== a && (o[a] = Fn.prototype[a]);
          for (var l in e.prototype)
            "constructor" !== l && (o[l] = e.prototype[l]);
        }
        return (
          (o = n = Ve(this, t.call(this, i, o))),
          (o.changing_ = !1),
          (r = o),
          Ve(n, r)
        );
    ...
    Xn = (function(t) {
      function e() {
        ...
        if (Pe) {
          o = de.createElement("custom");
          for (var s in Fn.prototype)
            "constructor" !== s && (o[s] = Fn.prototype[s]);
    ...
    Jn = { disabled: "disabled", hidden: "hidden", showing: "showing" },
    Qn = (function(t) {
      function e() {
        var n,
          r =
    ...
    fr = mt;
  (mt.XMLHttpRequest = le.XMLHttpRequest || Tt),
    (mt.XDomainRequest =
      "withCredentials" in new mt.XMLHttpRequest()
        ? mt.XMLHttpRequest
        : le.XDomainRequest),
    (function(t, e) {
      ...
      (n.oncue = function(t) {
        ...
        r.length > 0 &&
          (le.console &&
            ...
            le.console.groupCollapsed("Text Track parsing errors for " + e.src),
          r.forEach(function(t) {
            return Ye.error(t);
          }),
          le.console && le.console.groupEnd && le.console.groupEnd()),
        n.flush();
    },
    yr = function(t, e) {
      var n = { uri: t },
    ...
    gr = (function(t) {
      function e() {
        ...
        return (
          ...
          o.src ? ((l.src = o.src), yr(o.src, l)) : (l.loaded_ = !0),
          (r = l),
          Ve(n, r)
        );
      }
  ...
  (Cr.prototype.allowedEvents_ = { load: "load" }),
    (Cr.NONE = br),
    (Cr.LOADING = 1),
    (Cr.LOADED = Tr),
    (Cr.ERROR = 3);
  ...
  var Er = {
    ...
    wr = tt(kr, Er);
  (Er.names = Object.keys(Er)),
    (kr.names = Object.keys(kr)),
    (wr.names = [].concat(Er.names).concat(kr.names));
  var Sr =
    Object.create ||
    (function() {
      function t() {}
  ...
  (Ct.prototype = Sr(Error.prototype)),
      ...
      !(function() {
        for (var n, s, l = 0; l < e.length; l++)
          (s = e[l]),
            ...
            i.push(Mt.getSimpleBoxPosition(n));
      })();
  ...
  var Nr = Dt,
    Mr = "auto",
    Ir = { "": !0, lr: !0, rl: !0 },
    Dr = { start: !0, middle: !0, end: !0, left: !0, right: !0 };
    ...
    Vr = (function(t) {
      function e() {
        ...
        return (
          ...
          (i.autoRemoteTextTracks_ = new wr.text.ListClass()),
      ...
      return (
        ...
        (e.prototype.error = function(t) {
          return (
            void 0 !== t && ((this.error_ = new st(t)), this.trigger("error")),
            this.error_
          );
        }),
  ...
  wr.names.forEach(function(t) {
    ...
    (Vr.prototype.featuresVolumeControl = !0),
    (Vr.prototype.featuresFullscreenResize = !1),
    (Vr.prototype.featuresPlaybackRate = !1),
    (Vr.prototype.featuresProgressEvents = !1),
    (Vr.prototype.featuresTimeupdateEvents = !1),
    (Vr.prototype.featuresNativeTextTracks = !1),
    (Vr.withSourceHandlers = function(t) {
    ...
    En.registerComponent("Tech", Vr),
    Vr.registerTech("Tech", Vr),
    (Vr.defaultTechOrder_ = []);
  var Hr = {},
    Wr = { buffered: 1, currentTime: 1, duration: 1, seekable: 1, played: 1 },
    Ur = { setCurrentTime: 1 },
    zr = function t(e) {
      if (Array.isArray(e)) {
        var n = [];
  ...
  var Kr = (function(t) {
    ...
    return (
      ...
      (e.prototype.createEl = function() {
        ...
        return (
          De ||
            ((this.fallbackImg_ = v("img")), t.appendChild(this.fallbackImg_)),
          t
        );
      }),
  ...
  var Yr = {
    ...
    Gr = (function(t) {
      function e(n, r, i) {
        ...
        return (
          n.on("loadstart", pn(o, o.toggleDisplay)),
          n.on("texttrackchange", pn(o, o.updateDisplay)),
          n.on("loadstart", pn(o, o.preselectTrack)),
          n.ready(
            pn(o, function() {
      ...
      return (
        ...
        (e.prototype.clearDisplay = function() {
          "function" == typeof le.WebVTT &&
            le.WebVTT.processCues(le, [], this.el_);
        }),
        ...
        (e.prototype.updateForTrack = function(t) {
          if ("function" == typeof le.WebVTT && t.activeCues) {
            for (
              var e = this.player_.textTrackSettings.getValues(), n = [], r = 0;
              ...
              if (o) {
                ...
                if (
                  ...
                  e.backgroundOpacity &&
                    Qt(
                      s.firstChild,
                      "backgroundColor",
                      Jt(e.backgroundColor || "#000", e.backgroundOpacity)
                    ),
                  e.windowColor &&
                    (e.windowOpacity
                      ? Qt(
                ...
                e.fontFamily &&
                  ...
                  ("small-caps" === e.fontFamily
                    ...
                    : (s.firstChild.style.fontFamily = Yr[e.fontFamily]));
              }
            }
          }
        }),
    ...
    return (
      ...
      (e.prototype.addChild = function(t) {
        ...
        return (
          ...
          En.prototype.addChild.call(this, t, e)
        );
      }),
      (e.prototype.enable = function() {
  ...
  (Qr.prototype.controlText_ = "Play Video"),
    En.registerComponent("BigPlayButton", Qr);
  var Zr = (function(t) {
    function e(n, r) {
      Be(this, e);
      var i = Ve(this, t.call(this, n, r));
  ...
  var ei = (function(t) {
    function e(n, r) {
      ...
      var i = Ve(this, t.call(this, n, r));
      return (
        (i.throttledUpdateContent = dn(pn(i, i.updateContent), 25)),
    ...
    return (
      ...
      (e.prototype.updateTextNode_ = function() {
        if (this.contentEl_) {
          ...
          (this.textNode_ = de.createTextNode(this.formattedTime_ || "0:00")),
  ...
  (ni.prototype.controlText_ = "Current Time"),
    En.registerComponent("CurrentTimeDisplay", ni);
  var ri = (function(t) {
    function e(n, r) {
      Be(this, e);
      var i = Ve(this, t.call(this, n, r));
  ...
  (ri.prototype.controlText_ = "Duration Time"),
    En.registerComponent("DurationDisplay", ri);
  var ii = (function(t) {
    function e() {
      return Be(this, e), Ve(this, t.apply(this, arguments));
    }
  ...
  (oi.prototype.controlText_ = "Remaining Time"),
    En.registerComponent("RemainingTimeDisplay", oi);
  var si = (function(t) {
    function e(n, r) {
      Be(this, e);
      var i = Ve(this, t.call(this, n, r));
  ...
  (ui.prototype.options_ = { children: [] }),
    (Oe && !(Oe > 8)) ||
      be ||
      Ce ||
      ui.prototype.options_.children.push("timeTooltip"),
    En.registerComponent("PlayProgressBar", ui);
  var hi = (function(t) {
    function e(n, r) {
      Be(this, e);
      var i = Ve(this, t.call(this, n, r));
  ...
  (hi.prototype.options_ = { children: ["timeTooltip"] }),
  ...
  (di.prototype.options_ = {
    ...
    (Oe && !(Oe > 8)) ||
      be ||
      Ce ||
      di.prototype.options_.children.splice(1, 0, "mouseTimeDisplay"),
    (di.prototype.playerEvent = "timeupdate"),
    En.registerComponent("SeekBar", di);
  var fi = (function(t) {
    function e(n, r) {
      Be(this, e);
      var i = Ve(this, t.call(this, n, r));
      return (
        (i.handleMouseMove = dn(pn(i, i.handleMouseMove), 25)),
        (i.throttledHandleMouseSeek = dn(pn(i, i.handleMouseSeek), 25)),
        i.enable(),
        i
      );
    }
  ...
  (fi.prototype.options_ = { children: ["seekBar"] }),
  ...
  (vi.prototype.controlText_ = "Fullscreen"),
    En.registerComponent("FullscreenToggle", vi);
  var yi = function(t, e) {
  ...
  (mi.prototype.options_ = {
    ...
    (mi.prototype.playerEvent = "volumechange"),
    En.registerComponent("VolumeBar", mi);
  var _i = (function(t) {
    function e(n) {
      var r =
        arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
      ...
      return (
        yi(i, n),
        (i.throttledHandleMouseMove = dn(pn(i, i.handleMouseMove), 25)),
  ...
  (_i.prototype.options_ = { children: ["volumeBar"] }),
  ...
  (Ti.prototype.options_ = { children: ["muteToggle", "volumeControl"] }),
  ...
  var Ci = (function(t) {
    ...
    return (
      ...
      (e.prototype.createEl = function() {
        ...
        (this.contentEl_ = v(e, { className: "vjs-menu-content" })),
    ...
    function e(n, r) {
      ...
      if (
        ...
        s.on(["tap", "click"], function() {
          if ("object" !== Re(le.Event))
            try {
              c = new le.Event("change");
            } catch (t) {}
          c || ((c = de.createEvent("Event")), c.initEvent("change", !0, !0)),
            o.dispatchEvent(c);
        });
      }
  ...
  var xi = (function(t) {
    ...
    return (
      ...
      (e.prototype.handleTracksChange = function(t) {
        for (
          var e = this.player().textTracks(), n = !0, r = 0, i = e.length;
          r < i;
          r++
        ) {
          var o = e[r];
  ...
  var ji = (function(t) {
    function e(n) {
      var r =
        arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
      return (
        Be(this, e), (r.tracks = n.textTracks()), Ve(this, t.call(this, n, r))
      );
    }
    return (
      Fe(e, t),
  ...
  var Ai = (function(t) {
    function e(n, r) {
      ...
      return (
        (a.track = i),
        (a.cue = o),
        i.addEventListener("cuechange", pn(a, a.update)),
        a
      );
    }
    return (
    ...
    return (
      ...
      (e.prototype.createItems = function() {
        ...
        for (var n = 0, r = e.length; n < r; n++) {
          var i = e[n],
            o = new Ai(this.player_, { track: this.track_, cue: i });
          t.push(o);
        }
        return t;
      }),
  ...
  (Pi.prototype.kind_ = "chapters"),
    (Pi.prototype.controlText_ = "Chapters"),
    En.registerComponent("ChaptersButton", Pi);
  var Oi = (function(t) {
    function e(n, r, i) {
      Be(this, e);
      var o = Ve(this, t.call(this, n, r, i)),
    ...
    return (
      ...
      (e.prototype.handleTracksChange = function(t) {
        for (
          var e = this.player().textTracks(), n = !1, r = 0, i = e.length;
          r < i;
          r++
        ) {
          var o = e[r];
  ...
  (Oi.prototype.kind_ = "descriptions"),
    (Oi.prototype.controlText_ = "Descriptions"),
    En.registerComponent("DescriptionsButton", Oi);
  var Ni = (function(t) {
    function e(n, r, i) {
      return Be(this, e), Ve(this, t.call(this, n, r, i));
    }
  ...
  (Ni.prototype.kind_ = "subtitles"),
    (Ni.prototype.controlText_ = "Subtitles"),
    En.registerComponent("SubtitlesButton", Ni);
  var Mi = (function(t) {
    function e(n, r) {
      Be(this, e),
        (r.track = {
      ...
      (e.prototype.createItems = function() {
        ...
        return (
          (this.player().tech_ &&
            ...
            (e.push(new Mi(this.player_, { kind: this.kind_ })),
            (this.hideThreshold_ += 1)),
  ...
  (Ii.prototype.kind_ = "captions"),
    (Ii.prototype.controlText_ = "Captions"),
    En.registerComponent("CaptionsButton", Ii);
  var Di = (function(t) {
    function e() {
      return Be(this, e), Ve(this, t.apply(this, arguments));
    }
        ...
        return (
          "captions" === this.options_.track.kind &&
            (o +=
              ...
              "</span>\n      "),
          (o += "</span>"),
          t.prototype.createEl.call(this, e, r({ innerHTML: o }, n), i)
        );
      }),
      e
    );
    ...
    return (
      ...
      (e.prototype.createItems = function() {
        ...
        return (
          (this.player().tech_ &&
            this.player().tech_.featuresNativeTextTracks) ||
            (e.push(new Mi(this.player_, { kind: this.label_ })),
            (this.hideThreshold_ += 1)),
          (e = t.prototype.createItems.call(this, e, Di))
        );
      }),
      e
    );
  })(ji);
  (Li.prototype.kinds_ = ["captions", "subtitles"]),
    (Li.prototype.controlText_ = "Subtitles"),
    En.registerComponent("SubsCapsButton", Li);
  var Ri = (function(t) {
    function e(n, r) {
      Be(this, e);
      var i = r.track,
  ...
  var Bi = (function(t) {
    function e(n) {
      var r =
        arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
      return (
        Be(this, e), (r.tracks = n.audioTracks()), Ve(this, t.call(this, n, r))
      );
    }
    return (
      Fe(e, t),
  ...
  (Bi.prototype.controlText_ = "Audio Track"),
    En.registerComponent("AudioTrackButton", Bi);
  var Fi = (function(t) {
    function e(n, r) {
      Be(this, e);
      var i = r.rate,
  ...
  (Fi.prototype.contentElType = "button"),
    En.registerComponent("PlaybackRateMenuItem", Fi);
  var Vi = (function(t) {
    function e(n, r) {
      Be(this, e);
      var i = Ve(this, t.call(this, n, r));
      ...
      (e.prototype.createMenu = function() {
        ...
        if (e)
          for (var n = e.length - 1; n >= 0; n--)
            t.addChild(new Fi(this.player(), { rate: e[n] + "x" }));
        return t;
      }),
  ...
  (Vi.prototype.controlText_ = "Playback Rate"),
    En.registerComponent("PlaybackRateMenuButton", Vi);
  var Hi = (function(t) {
    function e() {
      return Be(this, e), Ve(this, t.apply(this, arguments));
    }
  ...
  var ro = (function(t) {
    function r(n, i) {
      ...
      return (
        (o.updateDisplay = pn(o, o.updateDisplay)),
        o.fill(),
        ...
        if (this.options_.persistTextTrackSettings) {
          ...
          try {
            Object.keys(t).length
              ? le.localStorage.setItem(
                  "vjs-text-track-settings",
                  JSON.stringify(t)
                )
              : le.localStorage.removeItem("vjs-text-track-settings");
          } catch (t) {
            Ye.warn(t);
          }
        }
    ...
    oo = (function(t) {
      function e(n, r) {
        ...
        return (
          ...
          i.featuresNativeTextTracks && s && Ye.warn(Ge(io)),
      ...
      return (
          ...
          var t = this.textTracks(),
            ...
            n = function() {
              ...
              for (var n = 0; n < t.length; n++) {
                var r = t[n];
                "metadata" === r.kind &&
                  e.push({ track: r, storedMode: r.mode });
              }
            };
          n(),
          ...
          if (
            ...
            if (t) {
              ...
              var i = this.options_.tag && k(this.options_.tag),
                o = tt({}, i);
              (Ie && !0 === this.options_.nativeControlsForTouch) ||
                delete o.controls,
                C(t, r(o, { id: this.options_.techId, class: "vjs-tech" }));
            }
            t.playerId = this.options_.playerId;
          }
          void 0 !== this.options_.preload &&
            w(t, "preload", this.options_.preload);
          for (
        ...
        (e.prototype.getVideoPlaybackQuality = function() {
          ...
          return (
            ...
            le.performance && "function" == typeof le.performance.now
              ? (t.creationTime = le.performance.now())
              : le.performance &&
                le.performance.timing &&
                "number" == typeof le.performance.timing.navigationStart &&
                (t.creationTime =
                  le.Date.now() - le.performance.timing.navigationStart),
            t
          );
        }),
        e
  ...
  if (h()) {
    ...
    (so.kind = "captions"),
      (so.srclang = "en"),
      (so.label = "English"),
      oo.TEST_VID.appendChild(so);
  }
  (oo.isSupported = function() {
    try {
      oo.TEST_VID.volume = 0.5;
    } catch (t) {
      return !1;
    }
    ...
    (oo.canControlVolume = function() {
      try {
        ...
        return (oo.TEST_VID.volume = t / 2 + 0.1), t !== oo.TEST_VID.volume;
      } catch (t) {
        return !1;
      }
    }),
    (oo.canControlPlaybackRate = function() {
      ...
      try {
        ...
        return (
          (oo.TEST_VID.playbackRate = t / 2 + 0.1),
          t !== oo.TEST_VID.playbackRate
        );
      } catch (t) {
        return !1;
      }
    ...
    (oo.prototype.featuresVolumeControl = oo.canControlVolume()),
    (oo.prototype.featuresPlaybackRate = oo.canControlPlaybackRate()),
    (oo.prototype.movingMediaElementInDOM = !be),
    (oo.prototype.featuresFullscreenResize = !0),
    (oo.prototype.featuresProgressEvents = !0),
    (oo.prototype.featuresTimeupdateEvents = !0),
    (oo.prototype.featuresNativeTextTracks = oo.supportsNativeTextTracks()),
    (oo.prototype.featuresNativeVideoTracks = oo.supportsNativeVideoTracks()),
    (oo.prototype.featuresNativeAudioTracks = oo.supportsNativeAudioTracks());
  ...
  (oo.patchCanPlayType = function() {
    ke >= 4 && !Se
      ? (oo.TEST_VID.constructor.prototype.canPlayType = function(t) {
    ...
    oo.patchCanPlayType(),
    (oo.disposeMediaElement = function(t) {
      if (t) {
    ...
    Vr.withSourceHandlers(oo),
    (oo.nativeSourceHandler = {}),
    (oo.nativeSourceHandler.canPlayType = function(t) {
      try {
        return oo.TEST_VID.canPlayType(t);
      } catch (t) {
        return "";
    ...
    oo.registerSourceHandler(oo.nativeSourceHandler),
    Vr.registerTech("Html5", oo);
  var uo = He(
      [
    ...
    po = (function(t) {
      function e(n, i, o) {
        ...
        (l.options_.playerOptions = u),
          ...
          be || l.addClass("vjs-workinghover"),
          (e.players[l.id_] = l);
        var p = oe.split(".")[0];
        return (
          l.addClass("vjs-v" + p),
      ...
      return (
        ...
        (e.prototype.createEl = function() {
          ...
          r
            ? (n = this.el_ = e.parentNode)
            : i || (n = this.el_ = t.prototype.createEl.call(this, "div"));
          var o = k(e);
          if (i) {
            for (
              n = this.el_ = e, e = this.tag = de.createElement("video");
              n.children.length;

            )
              e.appendChild(n.firstChild);
            m(n, "video-js") || _(n, "video-js"),
              n.appendChild(e),
          ...
          if (
            ...
            Object.getOwnPropertyNames(o).forEach(function(t) {
              "class" === t
                ? ((n.className += " " + o[t]),
                  i && (e.className += " " + o[t]))
                : (n.setAttribute(t, o[t]), i && e.setAttribute(t, o[t]));
            }),
            (e.playerId = e.id),
            (e.id += "_html5_api"),
        ...
        (e.prototype.updateStyleEl_ = function() {
          if (!0 === le.VIDEOJS_NO_DYNAMIC_STYLE) {
            ...
            return void (
              n && (t >= 0 && (n.width = t), e >= 0 && (n.height = e))
            );
          }
          var r = void 0,
            i = void 0,
        ...
        (e.prototype.loadTech_ = function(t, e) {
          ...
          "Html5" !== i &&
            this.tag &&
            (Vr.getTech("Html5").disposeMediaElement(this.tag),
          ...
          (this.tech_ = new a(s)),
            this.tech_.ready(pn(this, this.handleTechReady_), !0),
          ...
          this.isFullscreen(!0),
            t.requestFullscreen
              ? (X(
                  de,
                  t.fullscreenchange,
                  pn(this, function e(n) {
                    this.isFullscreen(de[t.fullscreenElement]),
                      !1 === this.isFullscreen() &&
                        q(de, t.fullscreenchange, e),
                      this.trigger("fullscreenchange");
                  })
                ),
        ...
        (e.prototype.enterFullWindow = function() {
          (this.isFullWindow = !0),
            (this.docOrigOverflow = de.documentElement.style.overflow),
            X(de, "keydown", pn(this, this.fullWindowOnEscKey)),
            (de.documentElement.style.overflow = "hidden"),
            _(de.body, "vjs-full-window"),
        ...
        (e.prototype.exitFullWindow = function() {
          (this.isFullWindow = !1),
            q(de, "keydown", this.fullWindowOnEscKey),
            (de.documentElement.style.overflow = this.docOrigOverflow),
            b(de.body, "vjs-full-window"),
  ...
  var vo = {},
    ...
    Co = (function() {
      function t(e) {
        if ((Be(this, t), this.constructor === t))
          throw new Error(
        ...
        (this.player = e),
          ...
          J(this, this.constructor.defaultState),
          mo(e, this.name),
          (this.dispose = pn(this, this.dispose)),
      ...
      return (
        ...
        (t.isBasic = function(e) {
          ...
          return (
            "function" == typeof n && !t.prototype.isPrototypeOf(n.prototype)
          );
        }),
        (t.registerPlugin = function(e, n) {
          ...
          else if (po.prototype.hasOwnProperty(e))
            throw new Error(
              'Illegal plugin name, "' +
                e +
          ...
          return (
            ...
            "plugin" !== e &&
              (t.isBasic(n)
                ? (po.prototype[e] = bo(e, n))
                : (po.prototype[e] = To(e, n))),
            n
          );
        }),
  ...
  (Co.getPlugin = go),
    (Co.BASE_PLUGIN_NAME = "plugin"),
    Co.registerPlugin("plugin", Co),
    (po.prototype.usingPlugin = function(t) {
  ...
  var ko = function(t, e) {
    ...
    Eo = function(t) {
      var e =
        ...
        r = {};
      "object" === (void 0 === e ? "undefined" : Re(e))
  ...
  if (
    ("undefined" == typeof HTMLVideoElement &&
      h() &&
      (de.createElement("video"),
      de.createElement("audio"),
      de.createElement("track"),
      de.createElement("video-js")),
    (re.hooks_ = {}),
    (re.hooks = function(t, e) {
      return (
        (re.hooks_[t] = re.hooks_[t] || []),
        e && (re.hooks_[t] = re.hooks_[t].concat(e)),
        re.hooks_[t]
      );
    }),
    ...
    (re.removeHook = function(t, e) {
      ...
      return (
        !(n <= -1) &&
        ((re.hooks_[t] = re.hooks_[t].slice()), re.hooks_[t].splice(n, 1), !0)
      );
    }),
    ...
    if (!wo) {
      ...
      var So = Je("head");
      So && So.insertBefore(wo, So.firstChild),
        hn(
          wo,
          "\n      .video-js {\n        width: 300px;\n        height: 150px;\n      }\n\n      .vjs-fluid {\n        padding-top: 56.25%\n      }\n    "
        );
  ...
  return (
    G(1, re),
    (re.VERSION = oe),
    (re.options = po.prototype.options_),
    (re.getPlayers = function() {
      return po.players;
    }),
    (re.players = po.players),
    (re.getComponent = En.getComponent),
    (re.registerComponent = function(t, e) {
      Vr.isTech(e) &&
        Ye.warn(
          "The " +
            t +
        ...
        En.registerComponent.call(En, t, e);
    }),
    (re.getTech = Vr.getTech),
    (re.registerTech = Vr.registerTech),
    (re.use = zt),
    (re.browser = Le),
    (re.TOUCH_ENABLED = Ie),
    (re.extend = Eo),
    (re.mergeOptions = tt),
    (re.bind = pn),
    (re.registerPlugin = Co.registerPlugin),
    (re.plugin = function(t, e) {
      return (
        Ye.warn(
          "videojs.plugin() is deprecated; use videojs.registerPlugin() instead"
        ),
        Co.registerPlugin(t, e)
      );
    }),
    (re.getPlugins = Co.getPlugins),
    (re.getPlugin = Co.getPlugin),
    (re.getPluginVersion = Co.getPluginVersion),
    (re.addLanguage = function(t, e) {
      var n;
      return (
        (t = ("" + t).toLowerCase()),
        (re.options.languages = tt(
          re.options.languages,
          ((n = {}), (n[t] = e), n)
        )),
        re.options.languages[t]
      );
    }),
    (re.log = Ye),
    (re.createTimeRange = re.createTimeRanges = it),
    (re.formatTime = Zt),
    (re.parseUrl = Zn),
    (re.isCrossOrigin = nr),
    (re.EventTarget = fn),

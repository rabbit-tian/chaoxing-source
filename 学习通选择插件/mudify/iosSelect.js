	...
	IosSelect.prototype = {
		...
		initLayer: function () {
			...
			var all_html = [
				...
				'</header>',
				'<ul class="list-box" style="height: ' + headerHeightCss + '; line-height: ' + headerHeightCss + ';overflow:hidden; width: 100%; background:#eee">',
					'<li class="start-time" style="width: 50%;float:left;">开始时间</li>',
					'<li class="end-time" style="width: 50%;float: left;">结束时间</li>',
				'</ul>',
				'<section class="iosselect-box1">',
			...
			this.iosSelectLayer.el.querySelector('.layer').style.height = this.options.itemHeight * this.options.itemShowCount + this.options.headerHeight*2 + this.options.cssUnit;
